            ...
            <div className="relative group">
                ...
                <div className="relative flex items-center">
                    <Input
                        ...
                        className="h-14 pl-12 pr-36 rounded-2xl border-white/20 dark:border-slate-700 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl shadow-xl text-lg placeholder:text-slate-400 dark:placeholder:text-slate-500 focus-visible:ring-babson-green-500/50"
                    />
